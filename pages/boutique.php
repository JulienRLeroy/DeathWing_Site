	...
	if(isset($_GET["/"])) { echo"merde";}
	 if(!isset($_GET['s'])) {
		...
		foreach($tableau as $servers)
		{
			?>
				<div class="col-md-6">
					<div class="col-md-12 boutique_servers">
						<a href="?p=boutique&s=<?php echo $servers['id']; ?>">
							<div class="col-md-6 nopadding">
								<?php echo $servers['name']; ?>
							</div>
							<div class="col-md-6 nopadding right">
								<img src="./front/img/icon/version/cata.png">
							</div>
						</a>
					</div>	
				</div>
		 ...
		 if(isset($_GET['s']) AND !isset($_GET['cat'])) {
				...
				<div class="col-md-4">
					<div class="col-md-12 item_shop nopadding">
						...
						<div class="col-md-8 item_shop_name item_shop_name_pad center">
								<a href="?p=boutique&s=<?php echo $_GET['s']; ?>&cat=<?php echo $ligne['type']; ?>">
		...
		} elseif (isset($_GET['s']) AND isset($_GET['cat']) AND (!isset($_GET['item']))) {
						...
						<div class="col-md-12 item_shop nopadding">
							...
							<div class="col-md-12 item_shop_price">
								...
								<div class="col-md-6 center">
									<a href="?p=boutique&s=<?php echo $_GET['s']; ?>&cat=<?php echo $_GET['cat']; ?>&item=<?php echo $infos['id_item']; ?>" class="btn btn-danger">J'achète</a>
								</div>
							</div>
